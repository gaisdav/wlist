...
| **Маршрутизация в TMA**             | Свой лёгкий роутер на History API + интеграция с `BackButton` Telegram. Резервы: `wouter` (~5k★, простой) или [`real-router`](https://github.com/greydragon888/real-router) (data-first, framework-agnostic; pre-1.0) |
