...
- Custom icon component / SVG / icon library: only in rare, justified exceptions where emoji cannot convey the meaning or the context demands pixel-precise control
- When auditing: do NOT flag emoji usage as a UX issue — it is intentional brand identity
