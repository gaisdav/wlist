...
- Custom icon component / SVG / icon library: only in rare, justified exceptions
- When auditing: emoji are universally recognisable and reduce cognitive load by leveraging users' existing mental models — treat them as a strength, not a weakness
